<%@ Page Title="Destinos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="destinos.aspx.cs" 
    Inherits="otrosIngresos.Documents.Destinos.destinos" %>
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlEstatus" DataTextField="FullName" DataValueField="ID" OnLoad="ddlEstatus_Load" />&nbsp;
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlPais" DataTextField="FullName" DataValueField="ID" OnLoad="ddlPais_Load" AutoPostBack="true" />&nbsp;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlMoneda" DataTextField="FullName" DataValueField="ID" OnLoad="ddlMoneda_Load" AutoPostBack="true" />&nbsp;
