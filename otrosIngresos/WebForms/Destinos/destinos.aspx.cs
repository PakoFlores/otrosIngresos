    ...
    public partial class destinos : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Rows.Add("@ordenInsercion", "VarChar", lbRutaOrden.Text);
                ...
                dt.Rows.Add("@archivoFactura", "VarChar", lbRutaFactura.Text);
                dt.Rows.Add("@archivoPago", "VarChar", lbRutaPago.Text);
                ...
                dt = action.EjecutarSP("spfctDestinoIns", dt);
