<%@ Page Title="Control de Publicidad" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="controlPublicidadConsulta.aspx.cs" 
    Inherits="otrosIngresos.Documents.ControlPublicidad.controlPublicidadConsulta" %>
            ...
            <asp:UpdatePanel ID="upControlPublicidad" runat="server">
                <ContentTemplate>
                    ...
                    <div class="scrolling-table-container">
                        <asp:GridView runat="server" ID="gvControlPublicidad" Font-Names="Trebuchet MS, Tahoma, Verdana, Arial" ClientIDMode="Static" 
                            ForeColor="#000333" GridLines="Both" Style="text-align: left" AutoGenerateColumns="false" Cellpadding="2" 
                            EmptyDataText="No existe información disponible." Width="600px" Font-Size="0.8em" OnRowDataBound ="gvControlPublicidad_RowDataBound"
                            OnPageIndexChanging="gvControlPublicidad_PageIndexChanging" OnRowCommand ="gvControlPublicidad_RowCommand"
                            ...
                            <Columns>
                                <asp:BoundField DataField="Fila" HeaderText="Fila" ItemStyle-Font-Size="1.2em" />
                                ...
                                <asp:BoundField DataField="Comentarios Adicionales" HeaderText="Comentarios Adicionales" ItemStyle-Font-Size="1.2em" HeaderStyle-Width="100px" ItemStyle-Width="100px" />
                                <asp:TemplateField HeaderText="Control de Acuerdos">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="Acuerdo" runat="server" NavigateUrl='<%# Eval("Control de Acuerdos", "~/Documents/Files/ControlPublicidad/{0}") %>'
                                            Text="Ver Acuerdo" Target="_blank" ForeColor="#ED1556" Font-Underline="true" Font-Size="0.8em" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Archivo SinMontos">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="ArchivoDetalle" runat="server" NavigateUrl='<%# Eval("Archivo Sin Montos", "~/Documents/Files/ControlPublicidad/{0}") %>'
                                            Text="Archivo SinMontos" Target="_blank" ForeColor="#ED1556" Font-Underline="true" Font-Size="0.8em" />
                                    </ItemTemplate>
                                </asp:TemplateField>
