<%@ Page Title="PPA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PPA.aspx.cs" Inherits="otrosIngresos.Documents.PPA.PPA" %>
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCFechaInicio" runat="server" Font-Size="Small" TextMode="Date" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCFechaFin" runat="server" Font-Size="Small" TextMode="Date" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtLFechaInicio" runat="server" Font-Size="Small" TextMode="Date" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtLFechaFin" runat="server" Font-Size="Small" TextMode="Date" />
                                    </td>
                                    <td>
